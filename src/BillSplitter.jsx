  ...
  return (
    <div className="container">
      <div className="card">
        ...
        <input type="number" placeholder="Enter tip amount" value={tipAmount} onChange={(e) => setTipAmount(e.target.value)} />

        <label>Number of People</label>
        <input type="number" placeholder="Enter number of people" value={numPeople} onChange={(e) => setNumPeople(e.target.value)} />
